...
namespace MyMusic
{
	...
	public partial class MainWindow : Window
	{
        ...
        private void SavePlayList()
        {
            ...
            //dong thu ba save selected index cua playlist dang chay
            writePlayList.WriteLine(playlistListBox.SelectedIndex);
            //dong thu tu save selected index cua song dang chay
            writePlayList.WriteLine(musicListBox.SelectedIndex);
        ...
        private void LoadPlayList()
        {
			try
			{
                ...
                var ValueProgressSlider = double.Parse(readerPlayList.ReadLine());
                var playListSelected = int.Parse(readerPlayList.ReadLine());
                var songSelected = int.Parse(readerPlayList.ReadLine());
